		...
		<table class="adminlist">
			<thead>
				<tr>
					...
					<th class="title" width="54%"><?php echo JHTML::_('grid.sort',  'Title', 'a.title', $this->lists['order_Dir'], $this->lists['order'] ); ?>
					</th>
					
					<th class="title" width="14%"><?php echo JHTML::_('grid.sort',  'Name', 'a.username', $this->lists['order_Dir'], $this->lists['order'] ); ?>
					</th>
